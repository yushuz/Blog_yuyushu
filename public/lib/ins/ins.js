    ...
    function(module, exports, __webpack_require__) {
      ...
      var render = function render(res) {
        ...
        for (var j = 0, len2 = res.list.length; j < len2; j++) {
          ...
          for (var i = 0, len = data.link.length; i < len; i++) {
            var minSrc = 'https://raw.githubusercontent.com/yushuz/Blog_Albumm/master/min_photos/' + data.link[i];
            var src = 'https://raw.githubusercontent.com/yushuz/Blog_Albumm/master/photos/' + data.link[i];
      ...
      function loadData(success) {
        if (!searchData) {
          ...
          xhr.open('GET', '../lib/ins/photo.json?t=' + +new Date(), true);
